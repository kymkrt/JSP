...
<head>
  ...
  <script>
  	...
  	function applicationDelete() {
			...
			location.href = "t3_ApplicationDeleteOk.jsp?applicationFlag="+applicationFlag; //get방식이라 ?뒤에 연결. 자바스크립트 변수라 뒤에+로 붙여준다 안에 쓰면 그냥 문자열
		}
...
<div class="container">
  ...
  <hr />
  <p><a href="t3_Application.jsp">돌아가기</a></p>
</div>
<p><br /></p>
</body>
</html>