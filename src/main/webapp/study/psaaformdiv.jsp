  ...
  <form name="myform" id="myform" method="post" action="">
	<table class="table">
  	<div class="mb-2">
	  	...
	  	<input type="text" name="mid" id="mid" value="" class="form-control" autofocus required />
  	</div>
  	<div class="mb-2">
	  	<label for="pwd" class="form-label">비밀번호</label>
	  	<input type="password" name="pwd" id="pwd" value="" class="form-control" required />
  	</div>
  	<div class="mb-2">
  	...
  	<div class="mb-2">
	  	<input type="radio" name="gender" id="male" value="남자" class="btn-check" checked /><label for="male" class="form-label btn btn-info">남자</label>
	  	<input type="radio" name="gender" id="female" value="여자" class="btn-check"  /><label for="female" class="form-label btn btn-info">여자</label>
  	</div>
  	<div class="mb-4">
