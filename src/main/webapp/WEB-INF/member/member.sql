...
drop table member;
/*values는 다 써야한다*/
insert into member values (default, 'admin', 'asdf1234', '관리맨', '관리자', '남자', default, '010-5165-3650', '28575 충북 청주시 서원구 사직대로 109, 4층', 'wh40k@naver.com', '관리자입니다', default, default, default, default, default, default, default, default, default, default);
select * from member;